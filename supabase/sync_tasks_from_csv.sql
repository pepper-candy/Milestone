...
FROM (VALUES
  ...
  (3,  'Math_S3_E1_P1', 'Consolidation', 'Consolidation', 'Reach the cut-off score.', 10, 1, 'Math_S2_E2_P1', 'Math_S2_E2_P2', false),
  (4,  'Math_S3_E1_P2', 'Consolidation', 'Consolidation', 'Reach the cut-off score.', 10, 1, 'Math_S2_E2_P1', 'Math_S2_E2_P2', false),
  (5,  'Math_S3_E2_P1', 'Consolidation', 'Consolidation', 'Reach the cut-off score.', 25, 1, 'Math_S3_E1_P1', 'Math_S3_E1_P2', false),
  (6,  'Math_S3_E2_P2', 'Consolidation', 'Consolidation', 'Reach the cut-off score.', 20, 1, 'Math_S3_E1_P1', 'Math_S3_E1_P2', false),
  (7,  'Math_S4_Q_Ch1', 'Pre-Learning', 'Pre-Learning', 'Reach the cut-off score.', 5, 1, 'Math_S3_E2_P1', 'Math_S3_E2_P2', false),
  (8,  'Math_S4_Q_Ch2', 'Pre-Learning', 'Pre-Learning', 'Reach the cut-off score.', 15, 1, 'Math_S3_E2_P1', 'Math_S3_E2_P2', false),
  (9,  'Math_S4_Q_Ch3', 'Pre-Learning', 'Pre-Learning', 'Reach the cut-off score.', 10, 1, 'Math_S3_E2_P1', 'Math_S3_E2_P2', false),
  (10, 'Math_S4_Q_Ch4', 'Pre-Learning', 'Pre-Learning', 'Reach the cut-off score.', 25, 1, 'Math_S4_Q_Ch2', NULL, false),
  (11, 'Math_S4_E1_P1', 'Pre-Learning', 'Pre-Learning', 'Reach the cut-off score.', 35, 1, 'Math_S4_Q_Ch4', NULL, false),
  (12, 'Math_S4_E1_P2', 'Pre-Learning', 'Pre-Learning', 'Reach the cut-off score.', 35, 1, 'Math_S4_Q_Ch4', NULL, false),
  (13, 'Eng_Writing_A1', 'Writing and Grammar', 'Writing and Grammar', 'Finish Writing Task with 4 steps.', 25, 0, NULL, NULL, false),
  (14, 'Eng_Writing_B2', 'Writing and Grammar', 'Writing and Grammar', 'Finish Writing Task with 4 steps.', 35, 0, NULL, NULL, false),
  (15, 'Eng_Writing_B3', 'Writing and Grammar', 'Writing and Grammar', 'Finish Writing Task with 4 steps.', 30, 0, 'Eng_Writing_B2', NULL, false),
  ...
  (22, 'Soc_Project_1', '社區專題', '社區專題', '完成 5分鐘 的簡短匯報。', 35, 0, NULL, NULL, true),
  (23, 'Soc_Project_2', '社區專題', '社區專題', '完成 5分鐘 的簡短匯報。', 30, 0, 'Soc_Project_1', NULL, true)
...
-- Sanity check:
-- SELECT task_no, exp, gem FROM tasks ORDER BY seq;
