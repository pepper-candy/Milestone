...
INSERT INTO tasks (task_no, category, exp, gem, title, description, requires_proof) VALUES
  ...
  ('Math_S3_E1_P1', 'math_s23', 10, 1, 'Math S3 E1 P1', 'Secondary 3 math exercise', false),
  ('Math_S3_E1_P2', 'math_s23', 10, 1, 'Math S3 E1 P2', 'Secondary 3 math exercise', false),
  ('Math_S3_E2_P1', 'math_s23', 25, 1, 'Math S3 E2 P1', 'Secondary 3 math exercise', false),
  ('Math_S3_E2_P2', 'math_s23', 20, 1, 'Math S3 E2 P2', 'Secondary 3 math exercise', false),
  ('Math_S4_Q_Ch1', 'math_s4', 5, 1, 'Math S4 Quiz Ch1', 'Secondary 4 quiz chapter 1', false),
  ('Math_S4_Q_Ch2', 'math_s4', 15, 1, 'Math S4 Quiz Ch2', 'Secondary 4 quiz chapter 2', false),
  ('Math_S4_Q_Ch3', 'math_s4', 10, 1, 'Math S4 Quiz Ch3', 'Secondary 4 quiz chapter 3', false),
  ('Math_S4_Q_Ch4', 'math_s4', 25, 1, 'Math S4 Quiz Ch4', 'Secondary 4 quiz chapter 4', false),
  ('Math_S4_E1_P1', 'math_s4', 35, 1, 'Math S4 E1 P1', 'Secondary 4 exam practice', false),
  ('Math_S4_E1_P2', 'math_s4', 35, 1, 'Math S4 E1 P2', 'Secondary 4 exam practice', false),
  ('Eng_Writing_A1', 'eng_writing', 25, 0, 'English Writing A1', 'Writing assignment A1', false),
  ('Eng_Writing_B2', 'eng_writing', 35, 0, 'English Writing B2', 'Writing assignment B2', false),
  ('Eng_Writing_B3', 'eng_writing', 30, 0, 'English Writing B3', 'Writing assignment B3', false),
  ...
  ('Soc_Project_1', 'community', 35, 0, 'Community Project 1', 'Requires location + photo proof', true),
  ('Soc_Project_2', 'community', 30, 0, 'Community Project 2', 'Requires location + photo proof', true)
