...
export const TASK_CATALOG: CatalogEntry[] = [
  ...
  { seq: 3, task_no: "Math_S3_E1_P1", category: "Consolidation", description: "Reach the cut-off score.", exp: 15, gem: 1, prereq_1: "Math_S2_E2_P1", prereq_2: "Math_S2_E2_P2" },
  { seq: 4, task_no: "Math_S3_E1_P2", category: "Consolidation", description: "Reach the cut-off score.", exp: 15, gem: 1, prereq_1: "Math_S2_E2_P1", prereq_2: "Math_S2_E2_P2" },
  { seq: 5, task_no: "Math_S3_E2_P1", category: "Consolidation", description: "Reach the cut-off score.", exp: 5, gem: 2, prereq_1: "Math_S3_E1_P1", prereq_2: "Math_S3_E1_P2" },
  { seq: 6, task_no: "Math_S3_E2_P2", category: "Consolidation", description: "Reach the cut-off score.", exp: 5, gem: 2, prereq_1: "Math_S3_E1_P1", prereq_2: "Math_S3_E1_P2" },
  { seq: 7, task_no: "Math_S4_Q_Ch1", category: "Pre-Learning", description: "Reach the cut-off score.", exp: 0, gem: 1, prereq_1: "Math_S3_E2_P1", prereq_2: "Math_S3_E2_P2" },
  { seq: 8, task_no: "Math_S4_Q_Ch2", category: "Pre-Learning", description: "Reach the cut-off score.", exp: 10, gem: 1, prereq_1: "Math_S3_E2_P1", prereq_2: "Math_S3_E2_P2" },
  { seq: 9, task_no: "Math_S4_Q_Ch3", category: "Pre-Learning", description: "Reach the cut-off score.", exp: 5, gem: 1, prereq_1: "Math_S3_E2_P1", prereq_2: "Math_S3_E2_P2" },
  { seq: 10, task_no: "Math_S4_Q_Ch4", category: "Pre-Learning", description: "Reach the cut-off score.", exp: 5, gem: 2, prereq_1: "Math_S4_Q_Ch2", prereq_2: null },
  { seq: 11, task_no: "Math_S4_E1_P1", category: "Pre-Learning", description: "Reach the cut-off score.", exp: 15, gem: 2, prereq_1: "Math_S4_Q_Ch4", prereq_2: null },
  { seq: 12, task_no: "Math_S4_E1_P2", category: "Pre-Learning", description: "Reach the cut-off score.", exp: 15, gem: 2, prereq_1: "Math_S4_Q_Ch4", prereq_2: null },
  { seq: 13, task_no: "Eng_Writing_A1", category: "Writing and Grammar", description: "Finish Writing Task with 4 steps.", exp: 5, gem: 1, prereq_1: null, prereq_2: null },
  { seq: 14, task_no: "Eng_Writing_B2", category: "Writing and Grammar", description: "Finish Writing Task with 4 steps.", exp: 15, gem: 1, prereq_1: null, prereq_2: null },
  { seq: 15, task_no: "Eng_Writing_B3", category: "Writing and Grammar", description: "Finish Writing Task with 4 steps.", exp: 5, gem: 1, prereq_1: "Eng_Writing_B2", prereq_2: null },
  ...
  { seq: 22, task_no: "Soc_Project_1", category: "社區專題", description: "完成 5分鐘 的簡短匯報。", exp: 0, gem: 2, prereq_1: null, prereq_2: null, requires_proof: true },
  { seq: 23, task_no: "Soc_Project_2", category: "社區專題", description: "完成 5分鐘 的簡短匯報。", exp: 5, gem: 1, prereq_1: "Soc_Project_1", prereq_2: null, requires_proof: true },
];
